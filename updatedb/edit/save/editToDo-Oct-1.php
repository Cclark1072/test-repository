...
<head>
  ...
  <title>Career Life Management | Edit TO DO Event</title>
...
<body id="page-top">
  ...
  ?>
	<script>
    	...
    	alert('user_login is: ' + user_login);
    	var loggedin = sessionStorage.getItem("loggedin");
    	alert('loggedin is: ' + loggedin);
    	document.cookie = "loggedin=" + loggedin;
    	
    	var to_do_id = sessionStorage.getItem("to_do_id");
    	document.cookie = "to_do_id=" + to_do_id;
    	document.write("In editToDo " + to_do_id);
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        //$user_login = $_SESSION['user_login'];
        $submit_edit_todo = $_POST['submit_edit_todo'];
        ...
        //$todo_query = "UPDATE `to_do` SET `todo_removed` = $todo_removed WHERE `to_do_id`=$to_do_id;";
        $todo_query = "UPDATE `to_do` SET (to_do_text, to_do_due_date) VALUES ('$to_do_text', '$to_do_due_date') WHERE `to_do_id`=$to_do_id;";
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Edit TO DO Event</h1>
          </div>
            ...
            <div class="col-xl-12 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                	...
                	<h6 class="m-0 font-weight-bold text-primary">Edit TO DO Event</h6>
    							...
    							echo '<form class="user" method="POST">
                						<div class="form-group row">
                  							<div class="col-sm-12 mb-3 mb-sm-0">
                    							<span>Text</span>
                    							<input type="text" name="to_do_text" value="'. $row["to_do_text"] .'" class="form-control form-control-user" id="exampleToDoText" placeholder="To Do Text" required>
                  							</div>
                						</div>
                						...
                						<div class="form-group row">
                  							<div class="col-sm-12 mb-3 mb-sm-0">
                    							<span>Due Date</span>
                    							<input type="date" name="to_do_due_date" value='. $row["to_do_due_date"] .' class="form-control form-control-user" id="exampleDueDate" placeholder="To Do Due Date" required autofocus>
                  							</div>
                						</div>
                
                  					</form>
                  					
                  					<button type="submit" name="submit_edit_todo">Submit</button>';
              	...
              	<div class="box-footer clearfix no-border">
              		<button type="submit" name="submit_edit_todo">Submit</button>
              		<!--<button type="button" class="btn btn-default pull-right"><i class="fa fa-plus"></i><a href="../../pages/add_data/add_todo_index2.php"> Update item </a></button>-->
            	</div>
